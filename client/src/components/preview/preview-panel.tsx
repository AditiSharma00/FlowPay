  ...
  return (
    ...
    >
      <div className="rounded-[2rem] border border-amber-100 bg-gradient-to-b from-white via-amber-50/70 to-orange-50/70 p-4 shadow-[0_24px_70px_-48px_rgba(180,83,9,0.45)]">
        <div className="sticky top-0 z-20 mb-4 flex items-center justify-between rounded-[1.25rem] border border-amber-100 bg-white/90 px-4 py-3 backdrop-blur-xl shadow-[0_10px_30px_-22px_rgba(180,83,9,0.35)] xl:top-4">
          <div>
